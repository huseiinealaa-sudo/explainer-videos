...
Build (from the repo root):
    python projects/prover/prover_ep02_passes.py --preview   # 480p15 -> tmp/prover_ep02_passes/preview.mp4
    python projects/prover/prover_ep02_passes.py             # 1080p30 -> output/prover_ep02_passes.mp4
"""
import argparse
import sys
