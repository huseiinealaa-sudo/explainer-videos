...
the Emerson ROC800L flow calculations manual §6.1.1 (sources in projects/prover/sources/prover_ep05.md).
Every number comes from projects/prover/prover_demo_data.py.

Build (from the repo root):
    python projects/prover/prover_ep05_chronometry.py --preview   # 480p15 -> tmp/prover_ep05_chronometry/preview.mp4
    python projects/prover/prover_ep05_chronometry.py             # 1080p30 -> output/prover_ep05_chronometry.mp4
"""
import argparse
import sys
