...
- Purpose: one clip per function of `explainer/scenes.py`, in `LIBRARY` order; the corner shows `NN / 17  function_name()`, the bottom line a one-line English description, the narration names the scene in Arabic.
