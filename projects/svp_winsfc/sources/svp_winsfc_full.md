...
1. **Pt100 linear check.** (115.54 − 100) ÷ 0.385 = 40.36 °C, not 40.37 °C. 40.37 comes from the unrounded CVD resistance at 40 °C (115.5408 Ω). The video shows 40.36 °C.
2. **Composite MF = MF × CTPLm.** Not defined in the DFC manual (only the report field "Prover Meter Composite Factor", p. 4-13). The official definition (CFR, from API MPMS 12.2) is "a meter factor corrected from normal operating pressure to base pressure", i.e. MF × CPLm only; MF × CTPLm is the combined correction. Proposal: leave Composite MF out of the video (it stays computed in the data module).
...
4. **Water draw interval.** SVP §5.1 p. 5-1: every year or as the responsible parties decide; SVP §8.11 p. 8-41 (service offering): "Water draw (Recommended every 2 years)". Narration follows §5.1.
