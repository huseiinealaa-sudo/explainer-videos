...
NARRATION = [
    ...
    # 10 K or MF + outro
    "وَانْتَبِهْ: يُطَبَّقُ أَحَدُهُمَا فَقَطْ، كِي المُثْبَتُ أَوْ مُعَامِلُ العَدَّادِ، لَا كِلَاهُمَا؛ لِأَنَّ تَطْبِيقَهُمَا مَعًا يَعْنِي تَصْحِيحَ القِرَاءَةِ مَرَّتَيْنِ. فِي الحَلْقَةِ القَادِمَةِ: المُرُورُ، وَالشَّوْطُ، وَقَابِلِيَّةُ التَّكْرَارِ.",
]
